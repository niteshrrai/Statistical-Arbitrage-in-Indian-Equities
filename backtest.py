...
def backtesting(returns_data: pd.DataFrame,
    ...
    '''
    Statistical arbitrage backtesting strategy based on Avellaneda-Lee (2010).
    ...
    '''
    # Extract required data from dictionaries
    ...
    # Align returns data with s_scores dates
    ...
    for day in tqdm(range(n_days - 1)):
        ...
        for stock_idx, stock in enumerate(returns_aligned.columns):
            ...
            # Calculate factor contribution for this stock
